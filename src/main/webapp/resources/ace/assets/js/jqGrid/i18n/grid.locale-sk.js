...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "H?ada?",
		Reset: "Reset",
	    odata: [{ oper:'eq', text:"rovná sa"},{ oper:'ne', text:"nerovná sa"},{ oper:'lt', text:"menšie"},{ oper:'le', text:"menšie alebo rovnajúce sa"},{ oper:'gt', text:"vä�?šie"},{ oper:'ge', text:"vä�?šie alebo rovnajúce sa"},{ oper:'bw', text:"za�?ína s"},{ oper:'bn', text:"neza�?ína s"},{ oper:'in', text:"je v"},{ oper:'ni', text:"nie je v"},{ oper:'ew', text:"kon�?í s"},{ oper:'en', text:"nekon�?í s"},{ oper:'cn', text:"obahuje"},{ oper:'nc', text:"neobsahuje"}],
	...
	edit : {
		...
		msg: {
		    ...
		    number:"Prosím, vložte valídne �?íslo",
		    minValue:"hodnota musí býť vä�?šia ako alebo rovná ",
		    maxValue:"hodnota mus� b�? men�ia ako alebo rovn� ",
		    email: "nie je val�dny e-mail",
		    integer: "Prosím, vložte celé �?íslo",
