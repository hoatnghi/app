...
$.extend($.jgrid,{
	...
	search : {
		...
		Find: "Hledat",
		Reset: "Reset",
	    odata: [{ oper:'eq', text:"rovno"},{ oper:'ne', text:"nerovono"},{ oper:'lt', text:"menší"},{ oper:'le', text:"menší nebo rovno"},{ oper:'gt', text:"větší"},{ oper:'ge', text:"větší nebo rovno"},{ oper:'bw', text:"za�?íná s"},{ oper:'bn', text:"neza�?íná s"},{ oper:'in', text:"je v"},{ oper:'ni', text:"není v"},{ oper:'ew', text:"kon�?í s"},{ oper:'en', text:"nekon�?í s"},{ oper:'cn', text:"obahuje"},{ oper:'nc', text:"neobsahuje"}],
	...
	edit : {
		...
		msg: {
		    ...
		    number:"Prosím, vložte validní �?íslo",
